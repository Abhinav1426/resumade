...
class JsonToPDFBuilder:
    ...
    def build_pdf(self,buffer,data):
        ...
        self.render_personal_info(data['personal_information'])
    
        self.render_education_details(data['education'],doc)
    
        self.render_experiences_details(data['experiences'],doc)
    
        self.render_skills_details(data['skills'])
    
        self.render_projects_details(data['projects'],doc)
    
        self.render_extras_details(data['extracurricular/achievements'],doc)
    
        self.render_languages(data['languages'])
    
        self.render_summary_details(data['summary'])
    
        self.render_awards_details(data['awards'],doc)
    
        self.render_certifications(data['certifications'],doc)
